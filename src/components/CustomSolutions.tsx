...
// 1. TypeScript Props Interface එක අර්ථ දැක්වීම (App.tsx එකේ Error එක විසඳීමට)
    ...
    <section className="max-w-7xl mx-auto px-6 py-12">
      <div className="bg-[#f2ece4] rounded-3xl overflow-hidden shadow-sm grid grid-cols-1 md:grid-cols-2 items-center">
        ...
        <div className="p-8 md:p-14 lg:p-16 flex flex-col justify-center">
          ...
          {/* CTA Button - 2. Bulk Orders Page එකට Route වන පරිදි onClick එකතු කිරීම */}
          <div>
            <button 
              onClick={() => setCurrentPage && setCurrentPage('bulk-orders')}
              className="bg-[#1b5e3f] hover:bg-[#14472f] text-white font-medium px-8 py-3.5 rounded-full text-sm transition duration-300 shadow-md flex items-center justify-center space-x-2 cursor-pointer"
            >
