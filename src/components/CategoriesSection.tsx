...
// verbatimModuleSyntax error එක මඟහරවා ගැනීමට Standard Function Type එක යෙදීම:
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        {categoriesData.map((category) => (
          <div 
            ...
            className="relative group rounded-2xl overflow-hidden h-[420px] shadow-md cursor-pointer"
          >
            <img 
